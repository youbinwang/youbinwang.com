...
export const films: FilmProject[] = [
  {
    ...
    heroImage: '/images/films/fibonacci-hero.jpg',
    description: {
    ...
    synopsis: [
      ...
      {
        en: 'The "Fibonacci sequence" is a mathematical sequence notable for its distinct characteristics, where each term in the sequence is the sum of the two preceding terms, creating a sense of accumulation and recurrence.',
        cn: '"斐波那契数列"是一个以独特性质著称的数学序列，其中每一项都是前两项之和，蕴含着积累与循环的意味。',
      },
    ],
    gallery: [],
    links: {},
  ...
  },
  {
    ...
    heroImage: '/images/films/an-ignorant-night-hero.jpg',
    description: {
  ...
  },
  {
    ...
    heroImage: '/images/films/meme-contaminate-hero.jpg',
    description: {
