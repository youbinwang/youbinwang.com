...
| 优势 | 说明 |
|------|------|
| **脚步自适应** | 程序化拉伸根骨骼曲线，配合 Stride Warping（见 [动画系统 4.3.3](/docs/echo-quest/animation/)），脚步跨度自动适配 |
...
{/* ![LightAttackMotionWarping 函数蓝图](/images/echo-quest/motion-warping-function.png) */}
...
{/* ![ANS_AttackMotionWarping_Light 通知状态蓝图](/images/echo-quest/ans-attack-warping.png) */}
...
{/* ![蒙太奇轨道配置截图](/images/echo-quest/montage-warping-tracks.png) */}
