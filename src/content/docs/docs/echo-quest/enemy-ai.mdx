...
{/* ![BTT 任务节点内部逻辑示例 — BTT_ActiveComboGraph 通过 BPI_EnemyAI 接口调用 Pawn 函数的蓝图逻辑](/images/docs/echo-quest/ch6-enemy-ai/btt-active-combo-graph.png) */}
...
{/* ![EQS 运行时调试可视化（绿色=高分可选，红色=被剔除，蓝色=最终选中的最优点）](/images/docs/echo-quest/ch6-enemy-ai/eqs-strafe-debug.png) */}
